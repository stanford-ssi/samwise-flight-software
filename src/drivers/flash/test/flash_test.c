 ...
 * These tests verify persistent data storage functionality without requiring real hardware.
 */
...
static uint8_t mock_flash_data[256] = {0xFF}; // Initialize with erased flash pattern

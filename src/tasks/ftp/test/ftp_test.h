...
/* A. Packet Tracker Tests (ID 0X in ftp_test.c) */
...
/* D. Write File Data Tests (ID 3X in ftp_test.c) */
...
/* E. Cancel File Write Tests (ID 5X in ftp_test.c) */
int ftp_test_cancel_success(slate_t *slate);
int ftp_test_cancel_clears_state(slate_t *slate);

/* F. End-to-End Workflow Tests (ID 8X in ftp_test.c) */

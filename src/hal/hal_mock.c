...
static void hal_mock_gpio_set_function(hal_pin_t pin,
...
static void hal_mock_gpio_set_irq_enabled_with_callback(
...
static void hal_mock_spi_set_format(hal_spi_t spi, uint8_t data_bits,
...
static int hal_mock_spi_write_blocking(hal_spi_t spi, const uint8_t *src,
                                       size_t len)
{
    (void)spi;
    (void)src;
...
static int hal_mock_spi_read_blocking(hal_spi_t spi, uint8_t repeated_tx_data,
...
static int hal_mock_spi_write_read_blocking(hal_spi_t spi, const uint8_t *src,
                                            uint8_t *dst, size_t len)
{
    (void)spi;
    (void)src;
...
static int hal_mock_i2c_write_blocking_until(hal_i2c_t i2c, uint8_t addr,
...
static int hal_mock_i2c_read_blocking_until(hal_i2c_t i2c, uint8_t addr,
                                            uint8_t *dst, size_t len,
                                            bool nostop, uint64_t until)
{
    (void)i2c;
...
static void hal_mock_uart_set_format(hal_uart_t uart, uint8_t data_bits,
...
static void hal_mock_pwm_set_chan_level(unsigned int slice_num,
...
static void hal_mock_flash_range_program(uint32_t flash_offs,
...
void hal_mock_init(void)
{
    ...
    hal.gpio_set_irq_enabled_with_callback =
        hal_mock_gpio_set_irq_enabled_with_callback;
